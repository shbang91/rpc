...
RollingJointWorldNode::RollingJointWorldNode(const dart::simulation::WorldPtr &_world)
...
void RollingJointWorldNode::customPreStep() {
  ...
  //std::cout << "==============" << std::endl;
  //std::cout << robot_model_->GetLinkIso("end_effector").translation() << std::endl;
  //std::cout << robot_model_->GetLinkIso("end_effector").linear() << std::endl;
