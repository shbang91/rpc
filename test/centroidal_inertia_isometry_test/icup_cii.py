...
if __name__ == "__main__":
    ...
    valkyrie = pb.loadURDF(
        cwd + "/robot_model/icup/icup.urdf",
        INITIAL_POS,
        INITIAL_QUAT,
        useFixedBase=True,
    )
    ...
    ) = pybullet_util.get_robot_config(valkyrie, INITIAL_POS, INITIAL_QUAT, False)

    nominal_sensor_data = pybullet_util.get_sensor_data(
        valkyrie, joint_id, link_id, pos_basejoint_to_basecom, rot_basejoint_to_basecom
    )
