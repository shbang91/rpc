...
if __name__ == "__main__":
    # robot = load_robot_description("draco3_description",
    # root_joint=pin.JointModelFreeFlyer())
    robot = pin.RobotWrapper.BuildFromURDF(
        # cwd + '/robot_model/draco/draco_modified.urdf',
        cwd + '/robot_model/draco/draco_ik_collocated.urdf',
    ...
    data_saver = DataSaver('draco_cii_collocated_walking_pink.pkl')
