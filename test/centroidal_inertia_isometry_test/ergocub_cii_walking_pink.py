#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""ergoCub humanoid standing on two feet and reaching with a hand."""
...
## parameters
INITIAL_POS = [0., 0., 0.58]
INITIAL_QUAT = [0., 0., 0., 1.]
NUM_FLOATING_BASE = 5
NORMALIZE_FACTOR = 1.5 / 1.35

if __name__ == "__main__":
    robot = load_robot_description("ergocub_description",
    ...
    data_saver = DataSaver('ergocub_cii_walking_pink.pkl')
