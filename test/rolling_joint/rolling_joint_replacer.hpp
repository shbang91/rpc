...
class RollingJointReplacer{
    public:
      ...
      dart::dynamics::BodyNode* replace(dart::dynamics::SkeletonPtr old_skeleton, dart::dynamics::SkeletonPtr new_skeleton, dart::dynamics::BodyNode* old_node, dart::dynamics::BodyNode* new_parent);

    private:
      std::unordered_map<std::string, dart::dynamics::Joint*> m_mimic_joint_map;

      dart::dynamics::BodyNode* replaceL1withFixed(dart::dynamics::SkeletonPtr old_skeleton, dart::dynamics::SkeletonPtr new_skeleton, dart::dynamics::BodyNode* old_node, dart::dynamics::BodyNode* new_parent);
};
