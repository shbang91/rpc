...
struct RJProperties : DartGeneric1DJoint::Properties, RJUniqueProperties
{
    ...
    RJProperties(const DartGeneric1DJoint::Properties& genericJointProperties=DartGeneric1DJoint::Properties(), const RJUniqueProperties& plProperties=RJUniqueProperties());

    virtual ~RJProperties() = default;
};

class RollingJoint;
using RollingJointBase = dart::common::EmbedPropertiesOnTopOf<RollingJoint, RJUniqueProperties, DartGeneric1DJoint>;
...
class RollingJoint : public RollingJointBase
{
    public:
        ...
        // this is necessary
        DartGeneric1DJoint::JacobianMatrix getRelativeJacobianStatic(const DartGeneric1DJoint::Vector& positions) const override;
