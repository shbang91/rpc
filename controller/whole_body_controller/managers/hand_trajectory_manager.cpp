...
void HandTrajectoryManager::InitializeHandTrajectory(
  ...
  b_trajectory_initialized_ = true;

  double delta_pos_norm;
  Eigen::Quaterniond init_ori = Eigen::Quaterniond::Identity();
