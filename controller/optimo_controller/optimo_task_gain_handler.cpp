...
OptimoTaskGainHandler::OptimoTaskGainHandler(OptimoControlArchitecture *ctrl_arch)
  ...
  util::PrettyConstructor(1, "OptimoTaskGainHandler");
  std::string border = "=";
...
void OptimoTaskGainHandler::Process() {
  count_ += 1;
...
void OptimoTaskGainHandler::_ResetParams() {
...
bool OptimoTaskGainHandler::_TaskExists(const std::string &task_name) {
  ...
  if (task_map.find(task_name) == task_map.end()) {
    std::cout << "================================================"
              << std::endl;
    std::cout << "OptimoTaskGainHandler: Task not found" << std::endl;
    std::cout << "================================================"
              << std::endl;
    return false;
  }
