...
SingleSupportSwing_WBIC::SingleSupportSwing_WBIC(
  ...
  if (state_id_ == draco_states_wbic::kLFSingleSupportSwing) {
  ...
  } else if (state_id_ == draco_states_wbic::kRFSingleSupportSwing) {
...
void SingleSupportSwing_WBIC::FirstVisit() {
  ...
  if (state_id_ == draco_states_wbic::kLFSingleSupportSwing) {
    std::cout << "draco_states_wbic::LFSingleSupportSwing" << std::endl;
    ...
    std::cout << "draco_states_wbic::RFSingleSupportSwing" << std::endl;
...
StateId SingleSupportSwing_WBIC::GetNextState() {
  if (state_id_ == draco_states_wbic::kLFSingleSupportSwing)
    return draco_states_wbic::kRFContactTransitionStart;
  else if (state_id_ == draco_states_wbic::kRFSingleSupportSwing)
    return draco_states_wbic::kLFContactTransitionStart;
}
