...
// constexpr int l_wrist_pitch_link = 32;
// constexpr int l_sake_gripper_link = 34;
// constexpr int l_hand_contact = 36;
// constexpr int left_ezgripper_palm_link = 38;
// constexpr int left_ezgripper_finger_L1_1 = 40;
// constexpr int left_ezgripper_finger_L2_1 = 42;
