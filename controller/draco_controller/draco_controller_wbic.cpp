...
DracoControllerWBIC::DracoControllerWBIC(DracoTCIContainerWBIC *tci_container,
  ...
  util::PrettyConstructor(2, "DracoControllerWBIC");
...
DracoControllerWBIC::~DracoControllerWBIC() {
  delete wbic_;
  delete wbic_data_;
}

void DracoControllerWBIC::GetCommand(void *command) {
  if (sp_->state_ == draco_states::kInitialize) {
    ...
    wbic_->MakeTorque(wbc_qddot_cmd_, tci_container_->force_task_map_,
...
void DracoControllerWBIC::_SaveData() {
#if B_USE_ZMQ
