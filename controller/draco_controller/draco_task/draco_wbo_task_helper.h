...
extern "C" int Q_xyz_func(const casadi_real **arg, casadi_real **res,
...
extern "C" int Q_xyz_func_work(casadi_int *sz_arg, casadi_int *sz_res,
                               casadi_int *sz_iw, casadi_int *sz_w);
#define Q_xyz_func_SZ_ARG 190
#define Q_xyz_func_SZ_RES 2
#define Q_xyz_func_SZ_IW 0
#define Q_xyz_func_SZ_W 969
extern "C" int jac_Q_xyz_func(const casadi_real **arg, casadi_real **res,
                              casadi_int *iw, casadi_real *w, int mem);
...
extern "C" int jac_Q_xyz_func_work(casadi_int *sz_arg, casadi_int *sz_res,
                                   casadi_int *sz_iw, casadi_int *sz_w);
