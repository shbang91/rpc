#include "controller/draco_controller/draco_com_z_task.hpp"
...
DracoCoMZTask::UpdateJacobianDotQdot() {
  if (com_height_ == com_height::kCoM) {
...
DracoCoMZTask::SetParameters(const YAML::Node &node, const bool b_sim) {
