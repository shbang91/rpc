...
describe("generateRosMsgMergedSchema", () => {
    it("generates merged schema for ROS 1", () => {
        const mergedSchema = (0, generateRos_1.generateRosMsgMergedSchema)(testFixtures_1.exampleMessageWithoutArrayOfBytes, {
            rosVersion: 1,
        });
      ...
      "
    `);
        expect((0, rosmsg_1.parse)(mergedSchema)).toMatchInlineSnapshot(`
      [
        {
          "definitions": [
            {
    ...
    it("generates merged schema for ROS 2", () => {
      ...
      "
    `);
        expect((0, rosmsg_1.parse)(mergedSchema, { ros2: true })).toMatchInlineSnapshot(`
      [
        {
          "definitions": [
            {
    ...
    it.each(Object.values(schemas_1.foxgloveMessageSchemas))("generates parseable merged schemas", (schema) => {
        expect(() => (0, rosmsg_1.parse)((0, generateRos_1.generateRosMsgMergedSchema)(schema, { rosVersion: 1 }))).not.toThrow();
        expect(() => (0, rosmsg_1.parse)((0, generateRos_1.generateRosMsgMergedSchema)(schema, { rosVersion: 2 }), { ros2: true })).not.toThrow();
    });
});
//# sourceMappingURL=generateRos.test.js.map