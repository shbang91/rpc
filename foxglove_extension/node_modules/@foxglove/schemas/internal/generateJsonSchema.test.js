...
const generateJsonSchema_1 = require("./generateJsonSchema");
...
describe("generateJsonSchema", () => {
    ...
    it.each(Object.values(schemas_1.foxgloveMessageSchemas))("generates parseable JSON Schema for $name", (schema) => {
        ...
        expect(() => ajv.compile((0, generateJsonSchema_1.generateJsonSchema)(schema))).not.toThrow();
    });
});
//# sourceMappingURL=generateJsonSchema.test.js.map