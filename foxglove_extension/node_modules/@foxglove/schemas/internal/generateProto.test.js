...
const generateProto_1 = require("./generateProto");
const schemas_1 = require("./schemas");
const testFixtures_1 = require("./testFixtures");
describe("generateProto", () => {
    it("generates .proto files", () => {
        expect((0, generateProto_1.generateProto)(testFixtures_1.exampleMessage, [testFixtures_1.exampleEnum])).toMatchInlineSnapshot(`
    ...
    it("generates parseable .proto files", () => {
        ...
        root.addJSON(protobufjs_1.default.common.get("google/protobuf/timestamp.proto").nested);
        root.addJSON(protobufjs_1.default.common.get("google/protobuf/duration.proto").nested);
        for (const schema of Object.values(schemas_1.foxgloveMessageSchemas)) {
            ...
            root.add(protobufjs_1.default.parse((0, generateProto_1.generateProto)(schema, enums)).root);
        }
        expect(() => root.resolveAll()).not.toThrow();
    });
});
//# sourceMappingURL=generateProto.test.js.map