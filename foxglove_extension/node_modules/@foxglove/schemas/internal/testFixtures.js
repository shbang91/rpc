...
exports.exampleMessage = {
    ...
    fields: [
        ...
        })),
        {
            name: "field_enum",
            description: "An enum field",
            type: { type: "enum", enum: exports.exampleEnum },
        },
        {
...
exports.exampleMessageWithoutArrayOfBytes = {
    ...exports.exampleMessage,
    fields: exports.exampleMessage.fields.filter(({ name }) => name !== "field_bytes_array" && name !== "field_bytes_fixed_array"),
};
