...
from util.python_utils import liegroup, pybullet_util, util
...
if __name__ == "__main__":
    ...
    draco_humanoid = pb.loadURDF(
        cwd + "/robot_model/draco/draco_latest_collisions_with_gripper.urdf",
        Config.INITIAL_BASE_JOINT_POS,
        Config.INITIAL_BASE_JOINT_QUAT,
        useFixedBase=0,
    )
    ...
    c1 = pb.createConstraint(
        draco_humanoid,
        DracoManipulationLinkIdx.l_knee_fe_lp,
        draco_humanoid,
        DracoManipulationLinkIdx.l_knee_fe_ld,
    ...
    c2 = pb.createConstraint(
        draco_humanoid,
        DracoManipulationLinkIdx.r_knee_fe_lp,
        draco_humanoid,
        DracoManipulationLinkIdx.r_knee_fe_ld,
        jointType=pb.JOINT_GEAR,
        jointAxis=[0, 1, 0],
        parentFramePosition=[0, 0, 0],
        childFramePosition=[0, 0, 0],
    ...
    while True:
        ...
        # DracoManipulationLinkIdx.r_foot_contact)[0:3, 3]
        # print("------------------------------------")
