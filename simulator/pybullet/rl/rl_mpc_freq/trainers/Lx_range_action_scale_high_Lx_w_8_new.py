...
model_dir = cwd + "/rl_model/freq_env/Lx_range_action_scale_high_Lx_w_8_new/PPO"
env_dir = cwd + "/rl_env/freq_env/Lx_range_action_scale_high_Lx_w_8_new/PPO"
#import tracemalloc
import argparse
import torch
new_model = True
...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvMpcFreq_Lx_range_action_scale_high_Lx_w_8(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = render)

    monitor_env = Monitor(env)
    vec_env = DummyVecEnv([lambda: monitor_env])

    #MODEL EVALUATION
    # eval_env = DracoEnvMpcFreq_Lx_range_action_scale_high_Lx_w(mpc_freq, sim_dt,reduced_obs_size=reduced_obs_size, render = render)
    ...
    if new_model:
        tensorboard_dir = cwd + "/rl_log/freq_env/Lx_range_action_scale_high_Lx_w_8_new/"
