...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvMpcFreq_turn_20_v3(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = False)

    monitor_env = Monitor(env)
    vec_env = DummyVecEnv([lambda: monitor_env])

    #MODEL EVALUATION
    eval_env = DracoEnvMpcFreq_turn_20_v3(mpc_freq, sim_dt,reduced_obs_size=reduced_obs_size, render = render)
