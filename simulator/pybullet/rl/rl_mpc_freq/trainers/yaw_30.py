...
if __name__ == "__main__":
    ...
    #MODEL EVALUATION
    eval_env = DracoEnvMpcFreq_turn_30(mpc_freq, sim_dt,reduced_obs_size=reduced_obs_size, render = render)
    ...
    save_dir = str1 + f"yaw_30_n_steps8192_batch_1024_gSDE" 
    load_dir = str1 + f"yaw_30_n_steps8192_batch_1024_gSDE"
    ...
    ## train model
    if new_model:
        tensorboard_dir = cwd + "/rl_log/freq_env/ppo/yaw_30/"
