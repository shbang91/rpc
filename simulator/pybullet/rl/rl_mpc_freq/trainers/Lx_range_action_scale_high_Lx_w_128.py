...
model_dir = cwd + "/rl_model/freq_env/Lx_range_action_scale_high_Lx_w_128/PPO"
env_dir = cwd + "/rl_env/freq_env/Lx_range_action_scale_high_Lx_w_128/PPO"
#import tracemalloc
import argparse
import torch
new_model = False
...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvMpcFreq_Lx_range_action_scale_high_Lx_w(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = render)
    ...
    if new_model:
        tensorboard_dir = cwd + "/rl_log/freq_env/Lx_range_action_scale_high_Lx_w_128/"
