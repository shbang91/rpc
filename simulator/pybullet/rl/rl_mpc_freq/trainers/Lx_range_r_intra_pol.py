...
from simulator.pybullet.rl.rl_mpc_freq.envs.freq_env_Lx_range_r_intra_pol import DracoEnvMpcFreq_Lx_range_r_intra_pol

from config.draco.pybullet_simulation import Config

model_dir = cwd + "/rl_model/freq_env/Lx_range_r_intra_pol/PPO"
env_dir = cwd + "/rl_env/freq_env/Lx_range_r_intra_pol/PPO"
#import tracemalloc
import argparse
import torch
new_model = False
...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvMpcFreq_Lx_range_r_intra_pol(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = render)
    ...
    if new_model:
        tensorboard_dir = cwd + "/rl_log/freq_env/Lx_range_r_intra_pol/"
