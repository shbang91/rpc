...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvMpcFreq_Ly_range_new_reward_ss(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = render)
    ...
    if new_model:
        tensorboard_dir = cwd + "/rl_log/freq_env/Ly_range_comparison/"
