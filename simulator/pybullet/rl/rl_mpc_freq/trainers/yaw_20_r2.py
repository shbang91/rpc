...
from simulator.pybullet.rl.rl_mpc_freq.envs.freq_env_turn_20_r2 import DracoEnvMpcFreq_turn_20_v2
...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvMpcFreq_turn_20_v2(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = False)

    monitor_env = Monitor(env)
    vec_env = DummyVecEnv([lambda: monitor_env])

    #MODEL EVALUATION
    eval_env = DracoEnvMpcFreq_turn_20_v2(mpc_freq, sim_dt,reduced_obs_size=reduced_obs_size, render = render)
    ...
    save_dir = str1 + f"yaw_20_v2" 
    load_dir = str1 + f"yaw_20_v2"
