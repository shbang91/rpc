...
if __name__ == "__main__":
    ...
    load_path = os.path.join(cwd, 'rl_model/freq_env/Lx_range_action_scale/PPO/redObsLy_range__batch_2048_nsteps32768_plus')
    
    CURR_TIMESTEP = 30000000
    # CURR_TIMESTEP = 35000000
    # CURR_TIMESTEP = 40000000
    ...
    env = DracoEnvMpcFreq_Lx_range_action_scale(mpc_freq, sim_dt, eval = [0,0,0],reduced_obs_size=reduced_obs_size, 
                                              render = True)
