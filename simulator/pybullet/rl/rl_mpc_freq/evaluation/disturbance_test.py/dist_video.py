...
from simulator.pybullet.rl.rl_mpc_freq.envs.disturbance_env_Ly_10_video import DracoEnvMpcFreq_Ly_10_dist_video
...
if __name__ == "__main__":
    ...
    env = DracoEnvMpcFreq_Ly_10_dist_video(mpc_freq, 
                                sim_dt, 
                                eval = [0, 10, 0], 
