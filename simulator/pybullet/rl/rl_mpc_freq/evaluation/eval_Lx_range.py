...
if __name__ == "__main__":
    ...
    load_path = os.path.join(cwd, 'rl_model/freq_env/Lx_range/PPO/redObsLy_range__batch_2048_nsteps32768_plus')
    
    CURR_TIMESTEP = 21000000
    ...
    env = DracoEnvMpcFreq_Lx_range(mpc_freq, sim_dt, eval = [0,0,0],reduced_obs_size=reduced_obs_size, 
                                              render = True)
