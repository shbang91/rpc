...
if __name__ == "__main__":
    ...
    lr_callback = CallbackHyperparamsSchedulePPO_std()
    ...
    save_dir = str1 + str2 + f"mpc_freq{mpc_freq}_SIMdt{sim_dt}Yaw_{yaw_max}_lr_std_callback" 
    ...
    if new_model:
        ...
        load_dir = str1 + str2 + f"mpc_freq{mpc_freq}_SIMdt{sim_dt}Yaw_{yaw_max}_lr_std_callback" 
