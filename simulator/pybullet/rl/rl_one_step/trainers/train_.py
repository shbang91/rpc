...
if __name__ == "__main__":
    ...
    save_dir = str1 + str2 + f"mpc_freq{mpc_freq}_SIMdt{sim_dt}_Lx_{Lx}_Ly_{Ly}_Yaw_{yaw_max}_new_reward_2_128"         
    ## train model
    if new_model:
        ...
        #model_path = '/home/carlosaj/Desktop/rpc/rl_model/one_step/PPO/redOBSdetCOMMANDmpc_freq_SIMdt0.002_Lx_0.0_Ly_0.0_Yaw_20_new_reward_2_128/'
    ...
    while(True):
        try:
            ...
            with open('timesteps_3.txt', 'w') as f:
