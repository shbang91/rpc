...
if __name__ == "__main__":
    ...
    save_dir = str1 + str2 + f"mpc_freq{mpc_freq}_SIMdt{sim_dt}_Lx_{Lx}_Ly_{Ly}_Yaw_{yaw_max}_optuna_4"         
    ...
    n_steps = 512
    gamma = 0.99
    learning_rate = 0.004107252979314588
    ent_coef = 1.0909162554562198e-05
    clip_range = 0.3
    n_epochs = 20
    gae_lambda = 0.9
    max_grad_norm = 2
    vf_coef = 0.1311839239628051
    net_arch_type = 'tiny'
