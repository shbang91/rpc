...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvOneStepMpcRange(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = render)
    ...
    save_dir = str1 + f"Ly_range_new_r_second_end" 
    load_dir = str1 + f"Ly_range_new_r_second"
