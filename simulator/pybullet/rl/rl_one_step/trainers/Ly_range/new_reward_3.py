...
from simulator.pybullet.rl.rl_one_step.envs.Ly_range_new_r_2 import DracoEnvOneStepMpcRange_v2
...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvOneStepMpcRange_v2(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = render)

    monitor_env = Monitor(env)
    vec_env = DummyVecEnv([lambda: monitor_env])

    #MODEL EVALUATION
    eval_env = DracoEnvOneStepMpcRange_v2(mpc_freq, sim_dt,reduced_obs_size=reduced_obs_size, render = render)
