...
if __name__ == "__main__":
    ...
    save_dir = str1 + str2 + f"mpc_freq{mpc_freq}_SIMdt{sim_dt}Yaw_{yaw_max}_lr_linear_callback_3" 
    ...
    if new_model:
        ...
        load_dir = str1 + str2 + f"mpc_freq{mpc_freq}_SIMdt{sim_dt}Yaw_{yaw_max}_lr_linear_callback_3" 
