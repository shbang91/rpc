...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvOneStepMpcYaw_20(mpc_freq, sim_dt, reduced_obs_size=reduced_obs_size, render = render)

    monitor_env = Monitor(env)
    vec_env = DummyVecEnv([lambda: monitor_env])

    #MODEL EVALUATION
    eval_env = DracoEnvOneStepMpcYaw_20(mpc_freq, sim_dt,reduced_obs_size=reduced_obs_size, render = render)
    ...
    save_dir = str1 + f"Ly_turn_20_third" 
    load_dir = str1 + f"Ly_turn_20_third"
