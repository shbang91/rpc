...
from simulator.pybullet.rl.rl_one_step.envs.Lx_range_w_4 import DracoEnvOneStepMpc_Lx_range_w_4

from config.draco.pybullet_simulation import Config

model_dir = cwd + "/rl_model/Lx_range_w_4/PPO"
env_dir = cwd + "/rl_env/Lx_range_w_4/PPO"
#import tracemalloc
import argparse
...
if __name__ == "__main__":
    ...
    render = False
    env = DracoEnvOneStepMpc_Lx_range_w_4(mpc_freq,
                                          sim_dt,
    ...
    #MODEL EVALUATION
    # eval_env = DracoEnvOneStepMpc_Lx_range_w_4(
    ...
    save_dir = str1 + f"Lx_range_w_4"
    load_dir = str1 + f"Lx_range_w_4"
    ...
    if new_model:
        tensorboard_dir = cwd + "/rl_log/one_step/Lx_range_w_4/"
