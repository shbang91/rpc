...
class DracoEnvOneStepMpc_Lx_range_w_4(DracoEnv_v2):
    ...
    def __init__(self,
                 ...
                 eval=None,
                 burn_in: bool = False,
                 reduced_obs_size: bool = True,
                 render: bool = False,
                 disturbance: bool = False) -> None:
        super().__init__(mpc_freq,
                         sim_dt,
                         eval=eval,
    ...
    def _compute_reward(self, wbc_obs, action, done):
        ...
        self.reward_info = np.array([
            reward, self._w_alive_bonus,
            self.tracking_Lx_offset(),
            self.reward_tracking_com_Ly(), 999999,
...
if __name__ == "__main__":
    import math
    yaw = 20
    env = DracoEnvOneStepMpcRange_v2(0,
