...
class DracoEnvOneStepMpc_Ly_10_dist_video(DracoEnv_v2):
    def __init__(self, mpc_freq, sim_dt, eval = None, burn_in: bool = False, reduced_obs_size: bool = True, render: bool = False, disturbance: bool = False, video = None) -> None:
        ...
        """"For RL
        self._one_step_push_selection = {'short_push_y': [10, 0, -310], 
                                     'mid_push_x': [57, -80, 0], 
                                     'mid_push_y': [57, 0, 60], 
                                     'long_push_x': [572, 20, 0],                                       
                                     'long_push_y': [572, 0, 15], 
                                     'short_push_x': [10, -600, 0]} 
        """
        #For MPC
        self._one_step_push_selection = {'short_push_y': [10, 0, -200], 
                                     'mid_push_x': [57, -80, 0], 
                                     'mid_push_y': [57, 0, 20], 
                                     'long_push_x': [572, 15, 0],                                       
                                     'long_push_y': [572, 0, 2], 
                                     'short_push_x': [10, -600, 0]} 
        ...
        for i in self._one_step_push_selection:
            self._push_stack.append(self._one_step_push_selection[i])
