...
class DracoEnvOneStepMpcRange_v5(DracoEnv_v2):
    ...
    def _compute_reward(self, wbc_obs, action, done):
        ...
        self.reward_info = np.array([reward, self._w_alive_bonus,  self.tracking_Lx_offset(), self.reward_tracking_com_Ly(),
...
if __name__ == "__main__":
    import math
    yaw = 20
    env = DracoEnvOneStepMpcRange_v2( 0, Config.CONTROLLER_DT, reduced_obs_size=False, render = True)
