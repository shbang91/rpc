...
PYBIND11_MODULE(interrupt_py, m) {
  py::class_<InterruptHandler>(m, "InterruptHandler")
      ...
      .def("PressUp", &InterruptHandler::PressUp)
      .def("PressDown", &InterruptHandler::PressDown)
      .def("PressLeft", &InterruptHandler::PressLeft)
      .def("PressRight", &InterruptHandler::PressRight);
}
