...
public:
  ...
  void GetCommand(void *_sensor_data, void *_command_data) override {
    PYBIND11_OVERRIDE_PURE(void, Interface, GetCommand, _sensor_data,
                           _command_data);
  }
};
...
PYBIND11_MODULE(draco_interface_pybind, m) {
  ...
  py::class_<DracoSensorData>(m, "DracoSensorData")
      ...
      .def_readwrite("imu_frame_isometry_",
                     &DracoSensorData::imu_frame_isometry_)
      .def_readwrite("imu_frame_velocities_",
                     &DracoSensorData::imu_frame_velocities_)
  ...
  py::class_<DracoCommand>(m, "DracoCommand")
      .def(py::init<>())
      .def_readwrite("joint_positions_cmd_",
                     &DracoCommand::joint_positions_cmd_)
      .def_readwrite("joint_velocities_cmd_",
                     &DracoCommand::joint_velocities_cmd_)
