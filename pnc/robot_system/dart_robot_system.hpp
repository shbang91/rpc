...
class DartRobotSystem : public RobotSystem {
    public:
        ...
        virtual Eigen::VectorXd GetInertiaMatrix();
        ...
        virtual Eigen::Matrix<double, 6, Eigen::Dynamic> GetLinkJacobian(const std::string &_link_name); 
        virtual Eigen::Matrix<double, 6, 1> GetLinkJacobianDotQdot(const std::string &_link_name); 
