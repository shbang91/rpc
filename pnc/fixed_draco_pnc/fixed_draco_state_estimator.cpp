...
void FixedDracoStateEstimator::UpdateModelWithGroundTruth(FixedDracoSensorData *_sensor_data){
...
void FixedDracoStateEstimator::InitializeModel(FixedDracoSensorData *_sensor_data){
...
void FixedDracoStateEstimator::EstimateOrientation(FixedDracoSensorData* _sensor_data){
