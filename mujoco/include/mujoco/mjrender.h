...
struct mjrContext_ { // custom OpenGL context
  ...
  unsigned int offDepthStencil_r; // offscreen depth and stencil buffer for
                                  // resolving multisamples
  ...
  // framebuffer
  int currentBuffer; // currently active framebuffer: mjFB_WINDOW or
                     // mjFB_OFFSCREEN
