...
# xlist = time
# des_base_height_list = local_des['task_com_pos'][:, 2]
# act_base_height_list = local_act['task_com_pos'][:, 2]

# base_height_des_plt.set_data(xlist, des_base_height_list)
# base_height_act_plt.set_data(xlist, act_base_height_list)
# plt.show()
