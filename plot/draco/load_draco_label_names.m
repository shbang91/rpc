...
contact_acc_label = [ "wx_{dot}", "wy_{dot}", "wz_{dot}","x_{ddot}", "y_{ddot}", "z_{ddot}"];
...
draco_wbc_cost_labels = ["com\_xy\_task", "com\_z\_task", "joint\_task", "lf\_force\_task", "lf\_ori\_task", "lf\_pos\_task", ...
    "rf\_force\_task", "rf\_ori\_task", "rf\_pos\_task", "qddot\_regularization\_task", "Fr\_regularization\_task", "torso\_ori\_task", "upper\_body\_task"];