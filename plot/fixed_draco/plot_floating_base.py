...
#plot data
plot_vector_traj(time, base_com_pos, None, ['x', 'y', 'z'], 'g',
                 'base_com_pos')
plot_vector_traj(time, base_com_ori, None, ['x', 'y', 'z', 'w'], 'g',
                 'base_com_ori')
plot_vector_traj(time, base_com_lin_vel, None, ['x', 'y', 'z'], 'g',
                 'base_com_lin_vel')
plot_vector_traj(time, base_com_ang_vel, None, ['x', 'y', 'z'], 'g',
                 'base_com_ang_vel')
